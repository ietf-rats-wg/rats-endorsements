...
them with a public key it possesses, called a verification key below. While this is typical,
...
the Verifier must have a verification key for each Attester. Typically, the verification
...
cryptographically verify that the Evidence can be cryptographically shown
to have been generated by the Attester that has the key material associated
